...
pub(crate) struct App {
    ...
    rate_limit_update_generation: u64,
...
fn hydrate_startup_rate_limit_snapshots(
    chat_widget: &mut ChatWidget,
    snapshots: Vec<codex_app_server_protocol::RateLimitSnapshot>,
) {
...
impl App {
    ...
    pub async fn run(
        ...
        let initial_rate_limit_snapshots = bootstrap.initial_rate_limit_snapshots;
        ...
        hydrate_startup_rate_limit_snapshots(&mut chat_widget, initial_rate_limit_snapshots);
...
See the Codex keymap documentation for supported actions and examples."
        ...
        // Refresh reset-credit details and catch any account-pool updates that
        // landed after the cached bootstrap read, without delaying first paint.
