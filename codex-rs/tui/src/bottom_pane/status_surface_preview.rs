...
impl StatusSurfacePreviewItem {
    fn placeholder(self) -> &'static str {
        match self {
            ...
            StatusSurfacePreviewItem::ContextRemaining => "ctx 72% left",
            StatusSurfacePreviewItem::ContextUsed => "ctx 28% used",
            StatusSurfacePreviewItem::AccountStatus => "user@example.com (6%)",
            StatusSurfacePreviewItem::FiveHourLimit => "5h 80% left",
            StatusSurfacePreviewItem::WeeklyLimit => "weekly 60% left",
            StatusSurfacePreviewItem::CodexVersion => "0.0.0",
            StatusSurfacePreviewItem::ContextWindowSize => "272K window",
            StatusSurfacePreviewItem::UsedTokens => "9.65M used",
            StatusSurfacePreviewItem::TotalInputTokens => "457M in",
            StatusSurfacePreviewItem::TotalOutputTokens => "1.2M out",
            ...
            StatusSurfacePreviewItem::TaskProgress => "Tasks 2/5",
        }
    }
