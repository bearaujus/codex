...
mod tests {
    ...
    fn plan_type_deserializes_raw_aliases() {
        assert_eq!(
            ...
            PlanType::Known(KnownPlan::Ent26)
        );
        assert_eq!(
    ...
    #[test]
    fn ent26_uses_enterprise_display_and_workspace_semantics() {
        assert_eq!(KnownPlan::Ent26.display_name(), "Enterprise");
        assert_eq!(KnownPlan::Ent26.raw_value(), "ent26");
        assert_eq!(KnownPlan::Ent26.is_workspace_account(), true);
    }
}
