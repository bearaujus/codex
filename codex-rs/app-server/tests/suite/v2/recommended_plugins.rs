...
#[tokio::test]
async fn first_turn_after_chatgpt_login_waits_for_recommended_plugins() -> Result<()> {
    recommended_plugins_after_chatgpt_login(ToolSuggestFeature::Enabled).await
}

#[tokio::test]
async fn first_turn_after_chatgpt_login_waits_for_recommended_plugins_without_tool_suggest()
-> Result<()> {
    recommended_plugins_after_chatgpt_login(ToolSuggestFeature::Disabled).await
}

async fn recommended_plugins_after_chatgpt_login(
